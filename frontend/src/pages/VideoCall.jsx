...
const {id} = useParams()
   ...
   // generate Kit Token
    ...
    const kitToken =  ZegoUIKitPrebuilt.generateKitTokenForTest(appID, serverSecret, id, Date.now().toString() , "shivam");
  ...
  >
    ...
    <p className="text-lg text-white z-10 animate-pulse">Loading video call...</p>
  </div>
