      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="w-full md:w-1/2 text-left">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">
            About <span className="text-indigo-300">XpertSwap</span>
          </h2>
          <p className="text-sm sm:text-base mb-4 leading-relaxed text-white font-bold font-Poppins">
            XpertSwap is a platform for students and recent graduates to meet mentors, learners, and fellow professionals to exchange valuable skills.
            Whether you're preparing for your next job, learning something new, or sharing your expertise, XpertSwap helps you build a strong skillset and connect meaningfully.
          </p>
